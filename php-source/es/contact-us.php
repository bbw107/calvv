...
$page_title = 'Contáctenos | California Vision and Visage';
$page_description = 'Contacte con California Vision and Visage — atención oftalmológica y estética en nuestras consultas de City of Industry y San Gabriel.';
    ...
    <section class="inner_hero bG_Blue padding_xl">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="heading">
                        <h1 class="textColor_White">Contáctenos</h1>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-6">
                    <div class="contact_div">
                        ...
                        <div class="contact_info">
                            ...
                            <p>( Ubicado entre Fullerton y Nogales, frente a Seasons Plaza )</p>
                            <p><strong>Teléfono</strong> <a href="tel:626-810-0689">626-810-0689</a></p>
                            <p><strong>Correo electrónico</strong> <a href="mailto:info@calvv.com">info@calvv.com</a></p>
                            <p><strong>De lunes a viernes</strong> 9:00am-5:00pm</p>

                            <div class="contact_divider"></div>

                            <p>7232 Rosemead Blvd, Suite 202 San Gabriel, CA 91775</p>
                            <p>( Al sur de Huntington Drive )</p>
                            <p><strong>Teléfono</strong> <a href="tel:626-656-6550">626-656-6550</a></p>
                            <p><strong>Correo electrónico</strong> <a href="mailto:info@calvv.com">info@calvv.com</a></p>
                            <p>Solo con cita previa</p>
                            <!-- Hidden at client request. The screen-reader
                                 notice still appears in the site footer. -->
                            <!--
                            <p>Si utiliza un lector de pantalla y tiene problemas para usar este sitio web, llame al <a href="tel:708-891-3330">(708) 891-3330</a></p>
                            <p><strong>Correo electrónico</strong> <a href="mailto:info@calvv.com">info@calvv.com</a></p>
                            -->
                        </div>
                    </div>
...
<?php endforeach; ?>
                            ...
                            <!-- Spam trap: hidden from people, filled in by bots. Positioned
                                 ...
                                 stay hidden, or visitors get a stray "Sitio web" field.
