...
$page_title = '联系我们 | California Vision and Visage';
$page_description = '联系 California Vision and Visage — 南加州 City of Industry 与 San Gabriel 两处眼科诊所。';
    ...
    <section class="inner_hero bG_Blue padding_xl">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="heading">
                        <h1 class="textColor_White">联系我们</h1>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-6">
                    <div class="contact_div">
                        ...
                        <div class="contact_info">
                            ...
                            <p>（位于 Fullerton 与 Nogales 之间，Seasons Plaza 对面）</p>
                            <p><strong>电话</strong> <a href="tel:626-810-0689">626-810-0689</a></p>
                            <p><strong>电子邮箱</strong> <a href="mailto:info@calvv.com">info@calvv.com</a></p>
                            <p><strong>周一至周五</strong> 上午9:00–下午5:00</p>

                            <div class="contact_divider"></div>

                            <p>7232 Rosemead Blvd, Suite 202 San Gabriel, CA 91775</p>
                            <p>（Huntington Drive 以南）</p>
                            <p><strong>电话</strong> <a href="tel:626-656-6550">626-656-6550</a></p>
                            <p><strong>电子邮箱</strong> <a href="mailto:info@calvv.com">info@calvv.com</a></p>
                            <p>仅限预约</p>
                            <!-- Hidden at client request. The screen-reader
                                 notice still appears in the site footer. -->
                            <!--
                            <p>如果您使用屏幕阅读器并在浏览本网站时遇到困难，请致电 <a href="tel:708-891-3330">(708) 891-3330</a></p>
                            <p><strong>电子邮箱</strong> <a href="mailto:info@calvv.com">info@calvv.com</a></p>
                            -->
                        </div>
                    </div>
...
<?php endforeach; ?>
                            ...
                            <!-- Spam trap: hidden from people, filled in by bots. Positioned
                                 ...
                                 stay hidden, or visitors get a stray "网站" field.
