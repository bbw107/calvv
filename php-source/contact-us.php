...
$page_title = 'Contact Us | California Vision and Visage';
$page_description = 'Contact California Vision and Visage — ophthalmology and aesthetic care at our City of Industry and San Gabriel offices in Southern California.';
    ...
    <section class="inner_hero bG_Blue padding_xl">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="heading">
                        <h1 class="textColor_White">Contact Us</h1>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-6">
                    <div class="contact_div">
                        ...
                        <div class="contact_info">
                            ...
                            <p>( Located between Fullerton and Nogales, across the street from Seasons Plaza )</p>
                            <p><strong>Phone</strong> <a href="tel:626-810-0689">626-810-0689</a></p>
                            <p><strong>Email</strong> <a href="mailto:info@calvv.com">info@calvv.com</a></p>
                            <p><strong>Monday to Friday</strong> 9:00am-5:00pm</p>

                            <div class="contact_divider"></div>

                            <p>7232 Rosemead Blvd, Suite 202 San Gabriel, CA 91775</p>
                            <p>( South of Huntington Drive )</p>
                            <p><strong>Phone</strong> <a href="tel:626-656-6550">626-656-6550</a></p>
                            <p><strong>Email</strong> <a href="mailto:info@calvv.com">info@calvv.com</a></p>
                            <p>By appointment only</p>
                            <!-- Hidden at client request. The screen-reader
                                 notice still appears in the site footer. -->
                            <!--
                            <p>If you are using a screen reader and are having problems using this website, please call <a href="tel:708-891-3330">(708) 891-3330</a></p>
                            <p><strong>Email</strong> <a href="mailto:info@calvv.com">info@calvv.com</a></p>
                            -->
                        </div>
                    </div>
...
<?php endforeach; ?>
                            ...
                            <!-- Spam trap: hidden from people, filled in by bots. Positioned
                                 ...
                                 stay hidden, or visitors get a stray "Website" field. -->
